...
void test_accepts_temperature_inside_limits(void) {
    TEST_ASSERT_TRUE(SensorSanity::isPlausibleTemperature(-39.9f));
    TEST_ASSERT_TRUE(SensorSanity::isPlausibleTemperature(59.9f));
}

void test_rejects_temperature_at_or_below_lower_limit(void) {
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleTemperature(-40.0f));
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleTemperature(-40.1f));
}

void test_rejects_temperature_at_or_above_upper_limit(void) {
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleTemperature(60.0f));
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleTemperature(60.1f));
}

void test_accepts_humidity_inside_limits(void) {
    TEST_ASSERT_TRUE(SensorSanity::isPlausibleHumidity(0.1f));
    TEST_ASSERT_TRUE(SensorSanity::isPlausibleHumidity(99.9f));
}

void test_rejects_humidity_at_or_below_lower_limit(void) {
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleHumidity(0.0f));
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleHumidity(-0.1f));
}

void test_rejects_humidity_at_or_above_upper_limit(void) {
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleHumidity(100.0f));
...
void test_accepts_absolute_humidity_inside_limits(void) {
    ...
    TEST_ASSERT_TRUE(SensorSanity::isPlausibleAbsoluteHumidity(149.9f));
}
...
void test_rejects_absolute_humidity_at_or_above_upper_limit(void) {
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleAbsoluteHumidity(150.0f));
    TEST_ASSERT_FALSE(SensorSanity::isPlausibleAbsoluteHumidity(150.1f));
}
